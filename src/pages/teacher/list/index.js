      ...
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          <Col md={8} sm={24}>
            ...
            rules: [{ required: false, message: 'Por favor informe o nome !', whitespace: true }],
          })(
...
this.searchFields();
       ...
       searchFields(){
        //+localStorage.getItem(SUCURSAL).id
          api.get('/api/teacher/1')
        .then(res => {  
    ...
    this.setState({data,teachers:data,lastdata:data,loadign:false,pagination});        
    ...
    { title: 'Nome', dataIndex: 'name', key: 'name',render:text=><a>{text}</a> },
      ...
      <div className={styles.tableListForm}>{this.renderForm()}</div>
        <div className={styles.tableListOperator}>
              <Button icon="plus" type="primary" onClick={()=>this.props.history.push('/teacher/create')} >
