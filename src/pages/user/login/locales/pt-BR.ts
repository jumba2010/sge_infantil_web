export default {
  ...
  'userandlogin.login.tab-login-credentials': 'Credenciais',
  'userandlogin.login.tab-login-mobile': 'Mobile number',
  'userandlogin.login.remember-me': 'Lembrar-me',
  'userandlogin.login.forgot-password': 'Esqueci-me da senha?',
  'userandlogin.login.sign-in-with': 'Entrar com',
  'userandlogin.login.signup': 'Cadastrar-se',
  'userandlogin.login.login': 'Fazer Login',
  ...
  'userandlogin.userName.required': 'Por favor informe o seu userName!',
  'userandlogin.password.required': 'Por favor informe a tua password!',
